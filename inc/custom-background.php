...
add_action( 'after_setup_theme', 'whimsy_custom_background_setup', 15 );
 ...
 * @return void
 */
function whimsy_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'whimsy_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function whimsy_custom_background_callback() {
