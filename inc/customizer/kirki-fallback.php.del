...
class Whimsy_Kirki {
	...
	public static function get_option( $config_id = '', $field_id = '' ) {
		...
		if ( class_exists( 'Kirki' ) ) {
			return Whimsy_Kirki::get_option( $config_id, $field_id );
		}
	...
	public static function add_panel( $id = '', $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			Whimsy_Kirki::add_panel( $id, $args );
		}
	}
	...
	public static function add_section( $id, $args ) {
		if ( class_exists( 'Kirki' ) ) {
			Whimsy_Kirki::add_section( $id, $args );
		}
	}
	...
	public static function add_config( $config_id, $args = array() ) {
		// if Kirki exists, use it.
		if ( class_exists( 'Kirki' ) ) {
			Whimsy_Kirki::add_config( $config_id, $args );
			return;
		}
	...
	public static function add_field( $config_id, $args ) {
		// if Kirki exists, use it.
		if ( class_exists( 'Kirki' ) ) {
			Whimsy_Kirki::add_field( $config_id, $args );
			return;
		}
